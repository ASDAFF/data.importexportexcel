...
require_once KDAPHPEXCEL_ROOT . 'PHPExcel/Shared/trend/bestFitClass.php';
require_once KDAPHPEXCEL_ROOT . 'PHPExcel/Shared/JAMA/Matrix.php';


/**
 * KDAPHPExcel_Polynomial_Best_Fit
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Shared_Trend
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Polynomial_Best_Fit extends KDAPHPExcel_Best_Fit
{
	/**
