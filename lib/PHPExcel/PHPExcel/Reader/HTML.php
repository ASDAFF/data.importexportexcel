...
/**
 * KDAPHPExcel_Reader_HTML
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Reader
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Reader_HTML extends KDAPHPExcel_Reader_Abstract implements KDAPHPExcel_Reader_IReader
{
	/**
	 * Input encoding
	 *
	...
	private $_formats = array( 'h1' => array( 'font' => array( 'bold' => true,
							   ...
							   'a'  => array( 'font' => array( 'underline' => true,
															   'color' => array( 'argb' => KDAPHPExcel_Style_Color::COLOR_BLUE,
															                   ),
															 ),
											),	//	Blue underlined
							   'hr' => array( 'borders' => array( 'bottom' => array( 'style' => KDAPHPExcel_Style_Border::BORDER_THIN,
																					 'color' => array( KDAPHPExcel_Style_Color::COLOR_BLACK,
																					                 ),
																				   ),
																),
											),	//	Bottom border
	...
	/**
	 * Create a new KDAPHPExcel_Reader_HTML
	 */
	...
	//	Data Array used for testing only, should write to KDAPHPExcel object on completion of tests
...
//						echo 'END OF TABLE ' , $this->_tableLevel , ' CELL<br />';
	...
	public function loadIntoExisting($pFilename, KDAPHPExcel $objKDAPHPExcel)
	{
		...
		if (!$this->_isValidFormat()) {
			...
			throw new KDAPHPExcel_Reader_Exception($pFilename . " is an Invalid HTML file.");
		}
		...
		if ($loaded === FALSE) {
			throw new KDAPHPExcel_Reader_Exception('Failed to load ',$pFilename,' as a DOM Document');
		}
		...
		$column = 'A';
		$content = '';
		$this->_processDomElement($dom,$objKDAPHPExcel->getActiveSheet(),$row,$column,$content);
...
//		var_dump($this->_dataArray);
	 ...
	 * @return KDAPHPExcel_Reader_HTML
	 */
