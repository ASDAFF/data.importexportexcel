...
class CKDAFieldList {
	...
	{
		?><select name="<?echo $fname;?>" class="kda-chosen-multi" multiple data-placeholder="<?echo Loc::getMessage('KDA_IE_PLACEHOLDER_CHOOSE');?>"><?echo $this->GetSelectPropertyList($IBLOCK_ID, $val, $prefix);?></select><?
	}
