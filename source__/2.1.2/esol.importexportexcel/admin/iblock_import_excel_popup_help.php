...
$imgPath = '/bitrix/panel/'.$moduleId.'/images_import/video_icons/';
...
<div class="kda-ie-tabs" id="kda-ie-help-tabs">
	...
	<div class="kda-ie-tabs-bodies">
		...
		<div>
			<div>&nbsp;</div>
			<p class="kda-ie-help-faq-prolog"><i><?echo sprintf(GetMessage("KDA_IE_FAQ_PROLOG"), 'app@esolutions.su', 'app@esolutions.su');?></i></p>
