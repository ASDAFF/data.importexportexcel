...
class KDAPHPExcel_Worksheet_BaseDrawing implements KDAPHPExcel_IComparable
{
    ...
    public function getCoordinatesTo() {
    	return $this->_coordinatesTo;
    }
     ...
     * @return KDAPHPExcel_Worksheet_BaseDrawing
     */
    public function setCoordinates($pValue = 'A1', $pValue2 = false) {
    	$this->_coordinates = $pValue;
    	$this->_coordinatesTo = $pValue2;
    	return $this;
    }
