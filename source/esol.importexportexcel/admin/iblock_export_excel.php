	...
	?>
		...
		<tr>
			...
			<td>
				...
				<td style="padding-left: 0px;"><input type="checkbox" name="SETTINGS_DEFAULT[EXPORT_TO_BX24]" value="Y" <?=htmlspecialcharsex($SETTINGS_DEFAULT['EXPORT_TO_BX24']=='Y' ? 'checked' : '')?> onchange="if(this.checked){$('#bx24p').show();}else{$('#bx24p').hide();}"></td>
				<td>&nbsp; &nbsp;</td>
				<td id="bx24p"<?if($SETTINGS_DEFAULT['EXPORT_TO_BX24']!='Y'){echo ' style="display: none;"';}?>>
					<div id="bx24_help" style="display: none;">
						<?$imgStr = '<img src="/bitrix/panel/'.$moduleId.'/export/images/%s">';?>
					...
					<div>
						...
						<div><input type="text" name="SETTINGS_DEFAULT[BX24_REST_URL]" value="<?=htmlspecialcharsex($SETTINGS_DEFAULT['BX24_REST_URL'])?>" id="bx24_rest_url" size="50"></div>
					...
					<div>
						...
						<div><input type="text" name="SETTINGS_DEFAULT[BX24_FOLDER_ID]" value="<?=htmlspecialcharsex($SETTINGS_DEFAULT['BX24_FOLDER_ID'])?>" id="bx24_folder_id" size="50"></div>
					</div>
					<br>
					<div>
		...
		<tr>
			...
			<td>
				<input type="checkbox" name="SETTINGS_DEFAULT[MERGE_SHEETS]" value="Y" <?=htmlspecialcharsex($SETTINGS_DEFAULT['MERGE_SHEETS']=='Y' ? 'checked' : '')?>>
			</td>
		</tr>
