...
$suffix = '';
$cronFrame = 'cron_frame_import.php';
if($_GET['suffix']=='highload') 
{
	$suffix = 'highload';
	$cronFrame = 'cron_frame_import_highload.php';
}
...
if ($_REQUEST["action"]=="save")
{
	...
	if (strlen($strErrorMessage)<=0 && $_REQUEST["subaction"]=='add')
	{
		...
		CheckDirPath($_SERVER["DOCUMENT_ROOT"].KDA_IE_PATH2EXPORTS."import_logs/");
		if (strlen($PROFILE_ID) > 0)
		{
			...
			$logFile = $_SERVER["DOCUMENT_ROOT"].KDA_IE_PATH2EXPORTS."import_logs/".$PROFILE_ID.".txt";
