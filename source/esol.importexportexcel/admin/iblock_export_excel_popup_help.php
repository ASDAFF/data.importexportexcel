...
$imgPath = '/bitrix/panel/'.$moduleId.'/images_export/video_icons/';
...
<div class="kda-ee-tabs" id="kda-ee-help-tabs">
	...
	<div class="kda-ee-tabs-bodies">
		...
		<div>
			<div>&nbsp;</div>
			<p class="kda-ee-help-faq-prolog"><i><?echo sprintf(GetMessage("KDA_EE_FAQ_PROLOG"), 'app@esolutions.su', 'app@esolutions.su');?></i></p>
